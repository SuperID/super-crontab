...
参数名称      | 类型    | 默认值       | 示例         |说明
------------:|-------:|------------:|------------:|-------------
match        | string | *           | v1.*.daily  | 仅仅匹配包含指定规则的任务名称
...
说明：此处返回结果的数据内容与**GET /job/:name/history_logs?filter=result**返回的一致
